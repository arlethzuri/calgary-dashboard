"""
Scrape ENMAX data from ArcGIS services.

The following script downloads metadata and features from ENMAX's public maps.

Downloaded data is saved under a directory labeled with the current date
at DATA_DIR as defined in config.py.
"""
