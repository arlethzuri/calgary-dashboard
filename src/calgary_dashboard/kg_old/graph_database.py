...
from calgary_dashboard.config.paths import PROCESSED_DATA_ROOT, PROJECT_ROOT
...
DEFAULT_DATA_ROOT = PROCESSED_DATA_ROOT
...
def main() -> None:
    ...
    parser.add_argument("--uri", default=_settings.neo4j_uri)
    parser.add_argument("--user", default=_settings.neo4j_user)
    parser.add_argument("--password", default=_settings.neo4j_password)
    parser.add_argument("--database", default=_settings.neo4j_database)
