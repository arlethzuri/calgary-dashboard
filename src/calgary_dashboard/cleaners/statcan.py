...
from calgary_dashboard.common.io import prepare_output_dirs, resolve_snapshot
...
# Dissemination area file was manually downloaded from:
...
def clean_snapshot(snapshot_date: str | None = None) -> Path:
    ...
    for prefix, data_path in data_by_prefix.items():
        ...
        # Create file names using product id and short title
...
def main() -> None:
    """Clean StatCan raw snapshot data."""
